...
export function ProjectCard({ project, layout = "column" }: ProjectCardProps) {
  ...
  return (
    <Link
      ...
      className={`block rounded-xl border border-white/10 bg-white/5 overflow-hidden hover:border-white/30 transition ${
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <span className="mt-4 text-sm underline underline-offset-4 group-hover:text-white">
          View Details →
        </span>
      </div>
    </Link>
