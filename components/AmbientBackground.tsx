...
export default function AmbientBackground() {
  ...
  className="absolute top-[-10%] left-[-10%] h-[40rem] w-[40rem] rounded-full bg-accent/[0.06] blur-[120px]"
/>
<motion.div
  animate={{ x: [0, -50, 0], y: [0, -30, 0] }}
  transition={{ duration: 22, repeat: Infinity, ease: "easeInOut" }}
  className="absolute bottom-[-10%] right-[-10%] h-[40rem] w-[40rem] rounded-full bg-accent/[0.05] blur-[120px]"
      />
